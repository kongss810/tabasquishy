...
!(function (e, t) {
        ...
        if (e)
            if ('string' == typeof e) {
                ...
                if (d.indexOf('<') >= 0 && d.indexOf('>') >= 0) {
                    ...
                    for (
                        o = t || '#' !== e[0] || e.match(/[ .<>:~]/) ? (t || i).querySelectorAll(e.trim()) : [i.getElementById(e.trim().split('#')[1])], n = 0;
                        n < o.length;
                        n += 1
                    )
                        o[n] && s.push(o[n]);
                ...
                for (var r = 0; r < i.length; r += 1) {
                    ...
                    if (t.watchSlidesVisibility || (t.centeredSlides && t.autoHeight)) {
                        ...
                        ((d >= 0 && d < this.size - 1) || (h > 1 && h <= this.size) || (d <= 0 && h >= this.size)) &&
                            (this.visibleSlides.push(o), this.visibleSlidesIndexes.push(r), i.eq(r).addClass(t.slideVisibleClass));
                    }
                    o.progress = s ? -l : l;
                }
    ...
    var w,
        ...
        A =
            ...
            !C &&
                D &&
                h.touch &&
                ((1024 === E && 1366 === T) || (834 === E && 1194 === T) || (834 === E && 1112 === T) || (768 === E && 1024 === T)) &&
            ...
            (x.webView =
                !(!(P || C || M) || (!y.match(/.*AppleWebKit(?!.*Safari)/i) && !a.navigator.standalone)) ||
                (a.matchMedia && a.matchMedia('(display-mode: standalone)').matches)),
            (x.webview = x.webView),
            (x.standalone = x.webView),
            (x.desktop = !(x.ios || x.android) || I),
            x.desktop && ((x.electron = I), (x.macos = D), (x.windows = L), x.macos && (x.os = 'macos'), x.windows && (x.os = 'windows')),
        ...
        if ((o.originalEvent && (o = o.originalEvent), t.isTouched)) {
            if (!t.isTouchEvent || 'touchmove' === o.type) {
                ...
                if (!this.allowTouchMove)
                    return (
                        (this.allowClick = !1),
                        void (t.isTouched && (d.extend(a, { startX: h, startY: p, currentX: h, currentY: p }), (t.touchStartTime = d.now())))
                    );
                        ...
                        if (
                            ...
                            if (
                                ...
                                f > 0 && t.currentTranslate > this.minTranslate()
                                    ? ((m = !1),
                                      s.resistance && (t.currentTranslate = this.minTranslate() - 1 + Math.pow(-this.minTranslate() + t.startTranslate + f, g)))
                                    : f < 0 &&
                            ...
                            s.followFinger &&
                                ...
                                s.freeMode &&
                                    (0 === t.velocities.length &&
                                        t.velocities.push({ position: a[this.isHorizontal() ? 'startX' : 'startY'], time: t.touchStartTime }),
                ...
                if (s.freeModeMomentum) {
                    ...
                    if (y < t.maxTranslate())
                        (s.freeModeMomentumBounce
                            ? (y + t.maxTranslate() < -S && (y = t.maxTranslate() - S), (x = t.maxTranslate()), (T = !0), (i.allowMomentumBounce = !0))
                            : (y = t.maxTranslate()),
                            s.loop && s.centeredSlides && (E = !0));
                    else if (y > t.minTranslate())
                        (s.freeModeMomentumBounce
                            ? (y - t.minTranslate() > S && (y = t.minTranslate() + S), (x = t.minTranslate()), (T = !0), (i.allowMomentumBounce = !0))
                            : (y = t.minTranslate()),
                            s.loop && s.centeredSlides && (E = !0));
    ...
    var W = {
                ...
                attachEvents: function () {
                    ...
                    ((e.preventClicks || e.preventClicksPropagation) && s.addEventListener('click', this.onClick, !0),
                        ...
                        e.updateOnWindowResize
                            ? this.on(A.ios || A.android ? 'resize orientationchange observerUpdate' : 'resize observerUpdate', N, !0)
            ...
            images: {
                loadImage: function (e, t, i, s, r, o) {
                    ...
                    n(e).parent('picture')[0] || (e.complete && r)
                        ? d()
                        : t
                          ? (((l = new a.Image()).onload = d), (l.onerror = d), s && (l.sizes = s), i && (l.srcset = i), t && (l.src = t))
                          : d();
                },
        ...
        te = {
            update: function (e) {
                ...
                if ((d.extend(t.virtual, { from: x, to: E, offset: T, slidesGrid: t.slidesGrid }), p === x && c === E && !e))
            ...
            renderSlide: function (e, t) {
                ...
                var s = i.renderSlide
                    ...
                    : n('<div class="' + this.params.slideClass + '" data-swiper-slide-index="' + t + '">' + e + '</div>');
        ...
        se = {
            handle: function (e) {
                ...
                if (
                    ...
                    (this.isHorizontal()
                        ? ((o || l || d || h) && (s.preventDefault ? s.preventDefault() : (s.returnValue = !1)),
                          (((l || h) && !t) || ((o || d) && t)) && this.slideNext(),
                          (((o || d) && !t) || ((l || h) && t)) && this.slidePrev())
                        : ((o || l || p || c) && (s.preventDefault ? s.preventDefault() : (s.returnValue = !1)),
                          (l || c) && this.slideNext(),
                          (o || p) && this.slidePrev()),
    ...
    var re = {
            ...
            handle: function (e) {
                ...
                var a = i.$el;
                if (
                    ('container' !== i.params.mousewheel.eventsTarged && (a = n(i.params.mousewheel.eventsTarged)),
                ...
                if ((s.invert && (r = -r), i.params.freeMode)) {
                    ...
                    if (
                        (x.push(y),
                        E
                            ? (y.direction !== E.direction || y.delta > E.delta || y.time > E.time + 150) && i.mousewheel.animateSlider(y)
        ...
        oe = {
            update: function () {
                ...
                if (t.el && this.pagination.el && this.pagination.$el && 0 !== this.pagination.$el.length) {
                    ...
                    if (
                        (this.params.loop
                            ? ((i = Math.ceil((this.activeIndex - this.loopedSlides) / this.params.slidesPerGroup)) > s - 1 - 2 * this.loopedSlides &&
                    ...
                    if (
                        ('fraction' === t.type &&
                            (a.find('.' + t.currentClass).text(t.formatFractionCurrent(i + 1)), a.find('.' + t.totalClass).text(t.formatFractionTotal(r))),
                        'progressbar' === t.type)
                    ) {
                        var y;
                    ...
                    ('custom' === t.type && t.renderCustom
                        ? (a.html(t.renderCustom(this, i + 1, r)), this.emit('paginationRender', this, a[0]))
            ...
            load: function () {
                ...
                if (o.loadPrevNext)
                    if (l > 1 || (o.loadPrevNextAmount && o.loadPrevNextAmount > 1)) {
                        for (
                            var c = o.loadPrevNextAmount, u = l, v = Math.min(a + u + Math.max(c, u), s.length), f = Math.max(a - Math.max(u, c), 0), m = a + l;
                            m < v;
                            m += 1
                        )
        ...
        ue = {
            ...
            updateNavigation: function () {
                if (!this.params.loop && this.navigation) {
                    ...
                    (i &&
                        i.length > 0 &&
                        (this.isBeginning ? (this.a11y.disableEl(i), this.a11y.makeElNotFocusable(i)) : (this.a11y.enableEl(i), this.a11y.makeElFocusable(i))),
                        t &&
                            t.length > 0 &&
                            (this.isEnd ? (this.a11y.disableEl(t), this.a11y.makeElNotFocusable(t)) : (this.a11y.enableEl(t), this.a11y.makeElFocusable(t))));
                }
            },
        ...
        ve = {
            ...
            setHistory: function (e, t) {
                if (this.history.initialized && this.params.history.enabled) {
                    ...
                    (r && r.value === s) ||
                        (this.params.history.replaceState ? a.history.replaceState({ value: s }, null, s) : a.history.pushState({ value: s }, null, s));
                }
            },
            slugify: function (e) {
                return e
        ...
        be = {
            setTranslate: function () {
                ...
                if (
                    ...
                    if (h)
                        e.transform(
                            'translate3d(0px, ' + (a / 2 + d.shadowOffset) + 'px, ' + -a / 2 + 'px) rotateX(90deg) rotateZ(0deg) scale(' + d.shadowScale + ')',
                        );
                    else {
            ...
            setTranslate: function () {
                for (var e = this.slides, t = this.rtlTranslate, i = 0; i < e.length; i += 1) {
                    ...
                    var r = -180 * a,
                        ...
                        d = 0;
                    if (
                        (this.isHorizontal() ? t && (r = -r) : ((d = l), (l = 0), (o = -r), (r = 0)),
                        ...
                        (0 === h.length && ((h = n('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? 'left' : 'top') + '"></div>')), s.append(h)),
                            0 === p.length &&
                                ((p = n('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? 'right' : 'bottom') + '"></div>')), s.append(p)),
        ...
        xe = {
            init: function () {
                ...
                (e.swiper instanceof t
                    ...
                    : d.isObject(e.swiper) &&
                      ((this.thumbs.swiper = new t(d.extend({}, e.swiper, { watchSlidesVisibility: !0, watchSlidesProgress: !0, slideToClickedSlide: !1 }))),
                    ...
                    if (this.realIndex !== t.realIndex || a) {
                        ...
                        (a && (r += 'next' === n ? s : -1 * s),
                            t.visibleSlidesIndexes &&
                                ...
                                (t.params.centeredSlides ? (r = r > o ? r - Math.floor(i / 2) + 1 : r + Math.floor(i / 2) - 1) : r > o && (r = r - i + 1),
        ...
        Ee = [
            ...
            },
            {
                ...
                create: function () {
                    var e = this;
                    (d.extend(e, {
                        a11y: { liveRegion: n('<span class="' + e.params.a11y.notificationClass + '" aria-live="assertive" aria-atomic="true"></span>') },
                    }),
                ...
                on: {
                    init: function () {
                        this.params.autoplay.enabled &&
                            (this.autoplay.start(), document.addEventListener('visibilitychange', this.autoplay.onVisibilityChange));
                    },
            ...
            },
            {
                ...
                create: function () {
                    d.extend(this, {
                        thumbs: { swiper: null, init: xe.init.bind(this), update: xe.update.bind(this), onThumbClick: xe.onThumbClick.bind(this) },
                    });
                },
                on: {
                    beforeInit: function () {
